        ...
        <main className={styles.banner}>
            <div className={styles.apresentacao}>
                ...
                <p className={styles.paragrafo}>
                    Desenvolvedor Front End apaixonado por designer web, com conhecimento em HTML5, CSS3, JavaScript e TypesScrip, sempre buscando expandir meus conhecimentos no Front End e em breve começar no mundo do Back End.
                </p>
